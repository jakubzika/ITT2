...
class CameraScene:
    ...
    async def start_service(self):
        ...
        cap = cv2.VideoCapture("/Users/jakubzika/Movies/Film 02.04.2023 v 11.30.mov")
    ...
    def init_fixed_camera_objects(self):
        obj1 = CameraObject("testing-1", 8, ObjectCategory.CITY, area_polygon = self.area_polygon)
        obj2 = CameraObject("testing-2", 17, ObjectCategory.CITY, area_polygon = self.area_polygon)
        objectRegistry.register_camera_object(obj1)
        objectRegistry.register_camera_object(obj2)
